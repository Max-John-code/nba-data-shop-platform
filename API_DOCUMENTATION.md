...
## 项目概述
NBA球星数据咨询是一个篮球资讯社区应用，提供NBA比赛信息、新闻资讯、用户认证等功能。
...
1. **数据库设计**
   ...
   - 新闻表：newsId, title, content, image, source, comments, likes, shares, category, createTime
   - 排行榜表：根据league和season存储球队和球员数据
